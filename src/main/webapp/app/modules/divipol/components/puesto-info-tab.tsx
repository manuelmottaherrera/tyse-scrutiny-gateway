              ...
              <div className="info-item">
                ...
                {puesto.latitud && puesto.longitud && (
                  ...
                  >
                    ...
                    <Translate contentKey="divipol.puestoDetail.verMapa">Ver en mapa</Translate>
                  </a>
                )}
              </div>
            </div>
      ...
      <Card className="mb-3">
        <CardBody>
          ...
          <Row>
            ...
            <Col sm={6} md={3}>
              <div className="stat-item">
                <span className="stat-value text-info">{puesto.potfemenino?.toLocaleString('es-CO')}</span>
                <span className="stat-label">
            ...
            <Col sm={6} md={3}>
              <div className="stat-item">
                <span className="stat-value text-primary">{puesto.potmasculino?.toLocaleString('es-CO')}</span>
                <span className="stat-label">
